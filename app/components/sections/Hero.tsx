      ...
      <section id="home" className="mx-auto flex max-w-[1200px] scroll-mt-28 flex-col items-center gap-12 px-gutter py-xl md:flex-row">
        <div className="flex-1">
          ...
          <button
            ...
            className="group relative rounded-lg bg-gradient-to-r from-primary to-blue-600 px-10 py-4 font-h3 text-h3 text-on-primary shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-primary/50 hover:scale-105 active:scale-95 overflow-hidden"
          >
